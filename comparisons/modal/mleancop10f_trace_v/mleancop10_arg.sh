...
PROVER_PATH=mleancop10f_trace_v
...
export TPTP=/Users/fredrik/Library/CloudStorage/OneDrive-UniversityofCambridge/Cambridge/conjectures/QMLTP-v1.1

#-------------
# Main Program

if [ $# -ne 3 ]; then
 echo "Usage: $0 <problem file> <logic> <domain>"
 exit 2
fi
