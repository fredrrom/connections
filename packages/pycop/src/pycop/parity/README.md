...
- `pycop.parity`: compare native behavior with leanCoP-family references.
- `pycop/parity/reference_provers/`: bundled reference prover assets used by
  parity diagnostics.
...
See `.github/CONTRIBUTING.md` in the repository root for the full developer workflow.
