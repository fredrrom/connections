%% File: def_mm.pl  -  Version: 1.01ep1  -  Date: 16 May 2019
%% Local notes:
%%  - merged former def_mm_f changes into def_mm.pl
%%  - added readable Skolem/definition naming in matrix translation
%%
...
%%          Matrix = [[-(p(X1))], [p(1 ^ [X1])]]
%%
%% Copyright: (c) 1999-2019 by Jens Otten
...
def((all X:Fml),FreeV,NNF,DEF,Paths,I,I1,Set) :- !,
    ...
    copy_term((X,Fml,FreeV),(SkTerm,Fml1,FreeV)), I2 is I+1,
...
def((A , B),FreeV,NNF,DEF,Paths,I,I1,Set) :- !,
    ...
    ( NNF3=(_;_), Set=def -> append([p_defini,I2],FreeV,DfPredL2),
                             DfPred2=..DfPredL2,
                             append([(~DfPred2,NNF3)],DEF3,DEF1),
                             NNF1=DfPred2, I3 is I2+1 ;
    ...
    ( NNF4=(_;_), Set=def -> append([p_defini,I4],FreeV,DfPredL4),
                             DfPred4=..DfPredL4,
                             append([(~DfPred4,NNF4)],DEF4,DEF2),
                             NNF2=DfPred4, I1 is I4+1 ;
