...
from pycop.parity.prefix_cases import (
    DEFAULT_FREE_VARIABLE_CASES,
    FreeVariableCase,
)
from pycop.parity.prefix_oracle import run_free_variable_case
from pycop.parity.prefix_syntax import parse_prefix, parse_term
