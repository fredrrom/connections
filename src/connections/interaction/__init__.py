...
_EXPORTS = {
    ...
    "ProverOutcome": "connections.interaction.outcome",
    "Result": "connections.interaction.result",
    "Stop": "connections.interaction.rollout",
    ...
    "StrategyResult": "connections.interaction.result",
